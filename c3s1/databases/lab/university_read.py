...
def read_faculty(session, university):
...
def read_specialization(session, university):
...
def read_group(session, university):
...
def read_professor(session, university):
...
def read_rector(session, university):
...
def read_student(session, university):
